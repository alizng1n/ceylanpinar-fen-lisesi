...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* DYNAMIC PORTAL BACKGROUND MODE (e-Okul Style) */
        body.portal-mode {
        ...
        body.portal-mode .theme-toggle {
            border: 1px solid rgba(255, 255, 255, 0.2) !important;
            color: #ffffff !important;
        }
        
        body.portal-mode .theme-toggle:hover {
            background: rgba(255, 255, 255, 0.1) !important;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* In mobile, e-Okul places student card colored pane on the right. We already implemented this! */
            ...
            <div class="portal-selection" id="selection-screen">
                ...
                <div id="portal-tab-home" style="display: flex; flex-direction: column; gap: 2rem; width: 100%;">
                    ...
                    <div class="selection-grid">
                        <!-- Öğretmen Giriş Kartı (Split pane: color left, text right) -->
                        ...
                        <!-- Öğrenci Giriş Kartı (Split pane: text left, color right) -->
                        <div class="split-btn-card" onclick="showStudentHub()">
                            <div class="pane-text">
                ...
                <!-- Sağ Taraf: Duyurular & Haberler (Tab-2 in Mobile) -->
