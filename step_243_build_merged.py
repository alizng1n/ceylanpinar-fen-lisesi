    ...
    <style>
        ...
        * {
        ...
        @media print {
            ...
            header, aside, .search-container, .btn, .header-actions, .theme-toggle, .dropzone, .sidebar-card, .toast, .portal-selection, .hub-section {
...
<body>
    ...
    <div class="app-container no-sidebar" id="app-container">
        <!-- Sidebar (Only shown in Analysis View) -->
        <aside>
            <!-- Portala Geri Dön Butonu -->
            <div class="sidebar-card">
                <button class="btn btn-secondary" style="width:100%;" onclick="showTeacherHub()" title="Öğretmen paneline geri döner">
                    <i data-lucide="arrow-left"></i> Portala Geri Dön
                </button>
            </div>
            ...
            <div class="analysis-section" id="teacher-analysis-view">
                ...
                <div class="search-container">
                    <div class="search-box-wrapper">
                        ...
                        <input type="text" class="search-input" id="search-student" placeholder="Öğrenci Adı veya Numarası ile Arayın..." autocomplete="off">
                    </div>
                ...
                <div class="info-card" id="student-report-card" style="display:none;">
                    ...
                    <div class="charts-container">
                        <div class="chart-card">
                            <h3>
                                <span><i data-lucide="trending-up" style="display:inline; vertical-align:-3px; margin-right:4px;"></i> Net Gelişim ve Kıyaslama Grafiği</span>
                                <span style="font-size:0.75rem; font-weight:normal; color:var(--text-secondary);">Mavi: Öğrenci Neti | Kırmızı: Okul Ortalaması</span>
                            </h3>
                ...
                <!-- Hoş Geldiniz Paneli (Analiz Görünümü için) -->
    ...
    <script>
        ...
        function handleLogoClick() {
            // Take back to current parent section
        ...
        function refreshDashboard() {
            ...
            document.getElementById('stat-exams').innerText = uniqueExams.size;
            document.getElementById('stat-avg-net').innerText = totalNetCount > 0 ? (totalNetSum / totalNetCount).toFixed(2) : "0.00";
        }
