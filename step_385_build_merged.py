...
def fetch_live_news_python():
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=8) as response:
            ...
            # Decode using Turkish character set (iso-8859-9)
            html_content = raw_body.decode('iso-8859-9', errors='ignore')
            # Unescape html entities (e.g. &#039; -> ')
            html_content = html.unescape(html_content)
            
            # Find news links using class alt_cizgi1
...
def build_merged_app():
    ...
    # Scrape news at build time
    live_news = fetch_live_news_python()
    
    # Render Left Column HTML (Haberler)
    ...
    # Render Right Column HTML (Duyurular)
...
<body class="portal-mode">
    ...
    <script>
        ...
        // Placeholders in compiled HTML template
        const leftColPlaceholder = `<!-- LEFT_NEWS_PLACEHOLDER -->`;
        const rightColPlaceholder = `<!-- RIGHT_NEWS_PLACEHOLDER -->`;
